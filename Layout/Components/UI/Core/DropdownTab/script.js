class DropdownTab {
    ...
    open() {
        this.menu.classList.add('dropdown-tab__menu--active');
        this.trigger.classList.add('dropdown-tab__trigger--active');
    ...
    close() {
        ...
        this.menu.classList.remove('dropdown-tab__menu--active');
        this.trigger.classList.remove('dropdown-tab__trigger--active');
        this.trigger.setAttribute('aria-expanded', 'false');
    }
